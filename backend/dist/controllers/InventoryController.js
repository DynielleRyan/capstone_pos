...
exports.deleteProductItem = exports.updateStock = exports.addStock = exports.getAllProductsWithStock = exports.getProductStock = exports.getProductItemsByProductId = exports.getAllProductItems = void 0;
...
exports.getAllProductItems = getAllProductItems;
// Get product items for a specific product
const getProductItemsByProductId = async (req, res) => {
    try {
...
exports.getProductItemsByProductId = getProductItemsByProductId;
...
const getAllProductsWithStock = async (req, res) => {
    try {
        ...
        const { data: productItems, error: itemsError } = await database_1.supabase
            .from('Product_Item')
...
exports.getAllProductsWithStock = getAllProductsWithStock;
// Add stock to a product item (or create new product item)
const addStock = async (req, res) => {
    try {
        const { ProductID, Stock, ExpiryDate, BatchNumber, Location, UserID } = req.body;
